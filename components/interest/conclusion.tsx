    ...
    return (
        <div className="lg:flex mx-[2rem] pt-[2rem] lg:pt-[5rem] h-[50rem] md:h-screen items-center lg:mb-0">
            <div className="flex flex-col lg:ml-[3rem] h-full">
                ...
                <div className="h-full flex flex-col justify-end text-center lg:text-start lg:text-[1rem] pb-[3rem] lg:pb-[2rem] font-medium">
