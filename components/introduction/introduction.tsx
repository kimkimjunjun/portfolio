...
export default function Introduction() {
    return (
        <div className="lg:flex ml-0 lg:ml-[5rem] mt-[2rem] lg:mt-[5rem] h-[16rem] items-center mb-[4rem] lg:mb-0">
            ...
            <div className="flex flex-col justify-center text-center lg:text-left lg:ml-[3rem]">
                <h1 className="text-[2rem] lg:text-[4rem] w-fit mx-auto lg:mx-0 h-[3rem] lg:h-[5rem] font-bold underline-animation">JUN HWI KIM</h1>
                <div className="flex flex-col text-[0.6rem] lg:text-[1rem] font-medium mt-[1rem]">
